...
// ===========================
//
// Enable elements that correspond to array members to be re-ordered
// using the HTML5 drag and drop API. Doing so will update the order
// of the array.
//
// Example usage:
//
...
//       el: document.body,
//       template: '<ul>{{#items}}<li decorator="sortable">{{.}}</li>{{/items}}</ul>',
//       data: { items: [ 'Firefox', 'Chrome', 'Internet Explorer', 'Opera', 'Safari', 'Maxthon' ] }
//     });
//
...
//
// Copyright 2013 Rich Harris, MIT licensed.
//
